    ...
    return (
      <Layout>
        <Wrapper>
          ...
          <Content>
            {
              pageState == config.pageState[config.siteState].sublevelList ? this.renderPostList(dashboard, subline) : 
              (pageState == config.pageState[config.siteState].post ? this.renderPost(dashboard, pageEntityId) : '')
            }
          </Content>
        </Wrapper>
      </Layout>
